...
flowchart TB
    ...
    PSM --> PRIV_ACCOUNTS
    CPM --> PRIV_ACCOUNTS
    ISSUING_CA --> USER_CERTS
    ISSUING_CA --> MACHINE_CERTS
    ISSUING_CA --> SSL_CERTS
    ROOT_CA --> ISSUING_CA
    OKTA -->|"SAML/OIDC"| CLOUD_APPS
    AD_FOREST -->|"Kerberos"| APPS
    AZURE_AD -->|"OAuth"| CLOUD_APPS
    OKTA --> OKTA_GROUPS
    AD_FOREST --> AD_GROUPS
    AD_GROUPS --> TARGET_SYSTEMS
    OKTA_GROUPS --> TARGET_SYSTEMS
    PSM -->|"Proxied Sessions"| SERVERS
    PSM -->|"Proxied Sessions"| DATABASES
    PSM -->|"Proxied Sessions"| NETWORK_DEV
```
...
|----------|-------|
| Domains | 800 |
| Domain Controllers | 50 |
| Endpoints (Windows/Mac) | 28,000 |
| Servers | 8,000 |
| Firewalls | 121 (all Palo Alto) |
| Networking Devices | 12,000 |
| Miscellaneous Appliances | 500 |

### Technology Stack Summary

| Category | Primary Tools |
|----------|---------------|
| SIEM/XDR | Palo Alto Cortex XSIAM |
| Email Security | Proofpoint |
| Web Protection | Akamai Kona Defender, F5 Shape Security |
| Cloud WAF | GCP Cloud Armor |
| Malware Sandbox | VMRay |
| Disk Forensics | EnCase |
| Log Analytics | Elastic + Kibana |
| Cloud Security | Prisma Cloud |
| DLP | Forcepoint, Prisma SaaS |
| Vulnerability Management | Tenable, Snyk, Reversing Labs |
| SSO | Okta |
| PAM | CyberArk |
| Customer Auth | Transmit Security |
| Threat Intelligence | Flashpoint, PhishLabs |
| Observability | Dynatrace, Moogsoft |
| Ticketing/CMDB | ServiceNow |
